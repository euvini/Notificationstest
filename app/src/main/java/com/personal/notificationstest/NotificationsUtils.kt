package com.personal.notificationstest
...
import com.personal.notificationstest.R.drawable.outline_refresh_black_24dp
...
fun Context.showNotification(channelId: String, title: String, body: String){
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
        ...
        builder = NotificationCompat.Builder(this, channelId).apply {
            setSmallIcon(outline_refresh_black_24dp)
